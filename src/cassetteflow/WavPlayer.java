...
public class WavPlayer {
     ...
     */
    public void playWithDefaultOutput(String filename)
    ...
    /**
     * Play a sound using the specific output ad wait for the sound to finish
     * playing
     ...
     * @throws InterruptedException
     */
    public void play(String filename, Mixer.Info info)
            throws UnsupportedAudioFileException, IOException, LineUnavailableException, InterruptedException {
        CountDownLatch syncLatch = new CountDownLatch(1);

        AudioInputStream inputStream = AudioSystem.getAudioInputStream(new File(filename));
        System.out.println(
                String.format("Playing through [%s] \nDescription [%s]\n\n", info.getName(), info.getDescription()));
     ...
     */
    public void playBigWav(File wavFile, Mixer.Info info)
    ...
    /**
     * Get the output device by index
     * 
     * @return
     */
    public static String getOutputDevice(int index) {
        return getOutputDevices().keySet().toArray()[index].toString();
    }
